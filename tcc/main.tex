...
\autor{Emily Sayuri Kiba}
% FIXME Substituir 'Título do trabalho' pelo título da trabalho.
\titulo{Manual Prático de Uso de Inteligência Artificial Gerativa na Criação de Modelos 3D para Jogos Digitais}
...
% programa/curso.
\coordenador{Profa. Lúcia Helena Martins Pacheco, Dra.}
...
\siglalista{PBR}{\textit{Physically Based Rendering}}
\siglalista{GANs}{\textit{Generative Adversarial Network}}
\siglalista{VAE}{\textit{Variational Autoencoder}}
\siglalista{LoRA}{\textit{Low-Rank Adaptation}}
\siglalista{VRAM}{\textit{Video Random Access Memory}}
